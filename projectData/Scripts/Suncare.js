...
function displayDetailsOfProducts(ele){
   ...
   div1.setAttribute('id','ViewImage');
    ...
    let div =  document.createElement('div');
      ...
      div.setAttribute('class', 'cart-img-container');

    //   div.innerHtml=` <div class="small-img-container"> <img src="" alt=""><img src="" alt=""></div><div class="target-img-container"><img  src="" alt=""></div>`
      
      let imgContainer =  document.createElement('div');
      imgContainer.setAttribute('class', 'small-img-container')

      let targetedImg = document.createElement('div');
      targetedImg.setAttribute('id','target-img-container');

      let img = document.createElement('img');
      let img1 = document.createElement('img');
      let img2 = document.createElement('img');

      imgContainer.append(img,img1);
      targetedImg.append(img2);
